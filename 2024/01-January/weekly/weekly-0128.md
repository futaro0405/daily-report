...
　AND file.day <= date("<% tp.date.now("YYYY-MM-DD", 4) %>")
```

```dataviewjs
const pages = dv.pages('"2024/01-January"').filter(p => p.file.name > "2024-01-28" && p.file.name < "2024-01-14").sort(p => p.file.name);
